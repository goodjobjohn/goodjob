...
<!--[if gt IE 8]><!--> <html <?php html_schema(); ?> <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<body <?php body_class(); ?> itemscope itemtype="https://schema.org/WebPage">
        ...
        <header class="header" id="header" role="banner" itemscope itemtype="https://schema.org/WPHeader">
            ...
            <div id="bloginfo" class="preload" itemscope itemtype="https://schema.org/Organization">
            ...
            <nav class="nav-container" role="navigation" itemscope itemtype="https://schema.org/SiteNavigationElement" aria-label="<?php _e( 'Primary Menu ', 'platetheme' ); ?>">
