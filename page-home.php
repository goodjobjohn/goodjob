		...
		<article id="post-14" class="post-14 page type-page status-publish hentry" role="article" itemscope="" itemtype="https://schema.org/BlogPosting">
			...
			<section class="entry-content" itemprop="articleBody">			
				...
				<div class="animated-logos">
						...
						<p>I’m offering a promo rate of $250 for custom animated logos. Give me 5 seconds - and I’ll bring your brand to life. <a href="<?php echo the_permalink(); ?>brand-motion/">Click here</a> to find out more about adding the finishing flowing touch to your narrative.</p>
