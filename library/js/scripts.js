...
function checkNavPosition() {
      ...
      const navBottom = navBar.offsetTop + navBar.offsetHeight + 50;

      if ( scrollPos > navBottom ) {
  ...
  window.addEventListener('scroll', debounce(checkNavPosition));
...
/*---------------------------------------
* Detect window is loaded
*----------------------------------------
* for CSS animations
*/
window.onload = (event) => {
  
    document.querySelector('#bloginfo').classList.remove('preload');
    document.querySelector('#main').classList.remove('preload');
 document.querySelector('.article-header').classList.remove('preload');
    document.querySelector('.article-footer').classList.remove('preload');
  

    // let animate = document.getElementsByClassName('preload');
    // let i = 0;

    // while (animate[i]) {
    //     animate[i].classList.remove('preload');
    //     i++;
    // }
}